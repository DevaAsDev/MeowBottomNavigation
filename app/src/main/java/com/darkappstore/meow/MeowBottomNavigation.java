...
public final class MeowBottomNavigation extends FrameLayout {
    ...
    public final void add(final Model model) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(0, this.heightCell, 1.0F);
    ...
    public final void setCount(int id, String count) {
        Model var10000 = this.getModelById(id);
        if (var10000 != null) {
            int pos = this.getModelPosition(id);
